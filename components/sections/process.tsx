    ...
    <section className="py-24 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 relative">
          ...
          <div className="hidden md:block absolute top-32 left-12 right-12 h-1 bg-gradient-to-r from-cyan-400 via-purple-500 to-cyan-400 -z-10" />
          ...
          {steps.map((step, index) => (
            ...
            >
              {/* Circle Background */}
              <div className="bg-gradient-to-b from-cyan-400/20 to-purple-500/20 rounded-full w-28 h-28 md:w-32 md:h-32 flex items-center justify-center mx-auto mb-6 group hover:from-cyan-400/40 hover:to-purple-500/40 transition-all duration-300">
                <div className="text-cyan-400">{step.icon}</div>
              </div>

              {/* Step Number */}
              <div className="text-center mb-4">
                <p className="text-3xl md:text-4xl font-bold text-purple-400 mb-2">{step.number}</p>
